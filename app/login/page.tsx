...
import { loginAction, signInWithGithub, signInWithGoogle } from "@/app/actions/auth-actions"
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2">
            ...
            <div className="hidden lg:flex flex-col bg-zinc-950 p-10 text-white relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-background opacity-50 z-0" />
                ...
                <div className="relative z-10 mt-auto">
                    ...
                    <p className="text-lg text-zinc-400 max-w-md">
                        Faça login para continuar sua jornada de aprendizado. Suas anotações, mapas mentais e questões esperam por você.
                    </p>
                </div>
            </div>
